...
>>
  ...
  %! baca.path.extern()
number.12.English_Horn.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.12.English_Horn.Music_Staff = <<
    ...
    \context Voice = "English_Horn.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.12.English_Horn.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.12.Percussion.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.12.Percussion.Music_Staff = <<
    ...
    \context Voice = "Percussion.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.12.Percussion.MusicVoice }
    % CLOSING:
    % COMMANDS:
