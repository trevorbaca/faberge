...
>>
  ...
  %! baca.path.extern()
number.16.Clarinet.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Piano_RH.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Piano_LH.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.16.Percussion.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.16.Percussion.Music_Staff = <<
    ...
    \context Voice = "Percussion.Music_Voice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.16.Percussion.Music_Voice }
    % CLOSING:
    % COMMANDS:
