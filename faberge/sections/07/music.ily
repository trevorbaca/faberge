...
>>
  ...
  %! baca.path.extern()
number.7.English_Horn.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.English_Horn.Music_Staff = <<
    ...
    \context Voice = "English_Horn.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.7.English_Horn.MusicVoice }
    % CLOSING:
    % COMMANDS:
