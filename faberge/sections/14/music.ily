...
>>
  ...
  %! baca.path.extern()
number.14.English_Horn.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [English_Horn.RestVoice measure 7]
              %! MULTIMEASURE_REST
              %! REST_VOICE
              %! baca._make_multimeasure_rest_container(5)
            R1 * 1
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [English_Horn.RestVoice measure 9]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.14.English_Horn.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "English_Horn.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.14.English_Horn.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.14.Piano_RH.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.14.Piano_LH.Attack_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Piano_LH.Attack_RestVoice measure 9]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.14.Piano_LH.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "Piano_LH.Attack_Voice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.14.Piano_LH.Attack_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.14.Percussion.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.14.Percussion.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "Percussion.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.14.Percussion.MusicVoice }
    % CLOSING:
    % COMMANDS:
