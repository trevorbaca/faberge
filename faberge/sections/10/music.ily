...
>>
  ...
  %! baca.path.extern()
number.10.English_Horn.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.10.English_Horn.Music_Staff = <<
    ...
    \context Voice = "English_Horn.Music_Voice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.10.English_Horn.Music_Voice }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.10.Piano_RH.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.10.Piano_LH.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
