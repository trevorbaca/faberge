...
music = baca.make_mmrests_function(commands.get(5, 9), head=voice.name)
voice.extend(music)
...
music = baca.make_mmrests_function(commands.get(6, 9), head=voice.name)
voice.extend(music)
...
music = library.make_back_incised_divisions(function=commands.get(1, 4))
voice.extend(music)
