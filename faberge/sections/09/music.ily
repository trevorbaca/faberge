...
>>
  ...
  %! baca.path.extern()
number.9.English_Horn.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [English_Horn.Rest_Voice measure 3]
              %! MULTIMEASURE_REST
              %! REST_VOICE
              %! baca._make_multimeasure_rest_container(5)
            R1 * 3
...
number.9.English_Horn.Music_Staff = <<
    ...
    \context Voice = "English_Horn.Music_Voice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.9.English_Horn.Music_Voice }
    % CLOSING:
    % COMMANDS:
