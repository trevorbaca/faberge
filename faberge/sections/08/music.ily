...
>>
  ...
  %! baca.path.extern()
number.8.English_Horn.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [English_Horn.RestVoice measure 6]
              %! MULTIMEASURE_REST
              %! REST_VOICE
              %! baca._make_multimeasure_rest_container(5)
            R1 * 3/2
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.8.English_Horn.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "English_Horn.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.8.English_Horn.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.8.Piano_LH.Attack_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Piano_LH.Attack_RestVoice measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
