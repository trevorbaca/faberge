...
>>
  ...
  %! baca.path.extern()
number.8.English_Horn.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.8.English_Horn.Music_Staff = <<
    ...
    \context Voice = "English_Horn.Music_Voice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.8.English_Horn.Music_Voice }
    % CLOSING:
    % COMMANDS:
