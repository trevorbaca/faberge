...
>>
  ...
  %! baca.path.extern()
segment.08.English_Horn_Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
segment.08.Piano_RH_Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
segment.08.Piano_LH_Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
segment.08.Piano_LH_Attack_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
