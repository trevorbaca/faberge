...
>>
  ...
  %! baca.path.extern()
number.4.English_Horn.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.English_Horn.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "English_Horn.MusicVoice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.4.English_Horn.MusicVoice }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.4.Piano_LH.Attack_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
