...
>>
  ...
  %! baca.path.extern()
number.4.English_Horn.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.4.English_Horn.Music_Staff = <<
    ...
    \context Voice = "English_Horn.Music_Voice"
      %! faberge.make_empty_score()
      %! baca.path.extern()
    { \number.4.English_Horn.Music_Voice }
    % CLOSING:
    % COMMANDS:
