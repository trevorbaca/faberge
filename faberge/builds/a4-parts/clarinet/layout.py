...
def main():
    ...
    layout = baca.layout.Layout(
        ...
        baca.layout.Page(
            ...
            baca.layout.System(208, y_offset=y_offset_8, distances=distances),
        ),
        baca.layout.Page(
            7,
            ...
            baca.layout.System(221, y_offset=y_offset_3, distances=distances),
            ...
            baca.layout.System(232, y_offset=y_offset_6, distances=distances),
            baca.layout.System(235, y_offset=y_offset_7, distances=distances),
            baca.layout.System(238, y_offset=y_offset_8, distances=distances),
        ),
        baca.layout.Page(
            8,
            ...
            baca.layout.System(249, y_offset=y_offset_3, distances=distances),
            baca.layout.System(253, y_offset=y_offset_4, distances=distances),
            baca.layout.System(257, y_offset=y_offset_5, distances=distances),
            baca.layout.System(261, y_offset=y_offset_6, distances=distances),
            baca.layout.System(265, y_offset=y_offset_7, distances=distances),
            baca.layout.System(269, y_offset=y_offset_8, distances=distances),
        ),
        baca.layout.Page(
            9,
            baca.layout.System(273, y_offset=y_offset_1, distances=distances),
            ...
            baca.layout.System(285, y_offset=y_offset_4, distances=distances),
        ),
        default_spacing=(1, 16),
        spacing_overrides=(
            baca.layout.Override(95, (1, 40)),
            baca.layout.Override(152, (1, 40)),
            baca.layout.Override(166, (1, 40)),
            baca.layout.Override(239, (1, 8)),
            baca.layout.Override(257, (1, 4)),
            baca.layout.Override(262, (1, 4)),
            baca.layout.Override(266, (1, 4)),
        ),
    )
