J_Global_Rests = {                                                             %! extern
    ...
    % [J Global_Rests measure 215 / measure 1]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [J Global_Rests measure 216 / measure 2]                                 %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
J_Global_Skips = {                                                             %! extern
    ...
    % [J Global_Skips measure 215 / measure 1]                                 %! _comment_measure_numbers
...
%@% - \baca-start-ct-both "[8'07'']" "[8'08'']"                                %! CLOCK_TIME_MARKUP
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    \baca-bar-line-visible                                                     %! _attach_final_bar_line
    \bar "|"                                                                   %! _attach_final_bar_line

    % [J Global_Skips measure 216 / measure 2]                                 %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
J_Flute_Music_Voice = {                                                        %! extern
    ...
    % [J Flute_Music_Voice measure 215 / measure 1]                            %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Flute_Music_Voice measure 216 / measure 2]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Flute_Rest_Voice measure 216 / measure 2]                     %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
...
J_English_Horn_Music_Voice = {                                                 %! extern
    ...
    % [J English_Horn_Music_Voice measure 215 / measure 1]                     %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J English_Horn_Music_Voice measure 216 / measure 2]             %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J English_Horn_Rest_Voice measure 216 / measure 2]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Clarinet_Music_Voice = {                                                     %! extern
    ...
    % [J Clarinet_Music_Voice measure 215 / measure 1]                         %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Clarinet_Music_Voice measure 216 / measure 2]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Clarinet_Rest_Voice measure 216 / measure 2]                  %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Piano_RH_Music_Voice = {                                                     %! extern
    ...
    % [J Piano_RH_Music_Voice measure 215 / measure 1]                         %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Piano_RH_Music_Voice measure 216 / measure 2]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Piano_RH_Rest_Voice measure 216 / measure 2]                  %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Piano_LH_Music_Voice = {                                                     %! extern
    ...
    % [J Piano_LH_Music_Voice measure 215 / measure 1]                         %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Piano_LH_Music_Voice measure 216 / measure 2]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Piano_LH_Rest_Voice measure 216 / measure 2]                  %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Piano_LH_Attack_Voice = {                                                    %! extern
    ...
    % [J Piano_LH_Attack_Voice measure 215 / measure 1]                        %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands
    - \tweak color #(x11-color 'green4)                                        %! REAPPLIED_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Piano_LH_Attack_Voice measure 216 / measure 2]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Piano_LH_Attack_Rest_Voice measure 216 / measure 2]           %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Percussion_Music_Voice = {                                                   %! extern
    ...
    % [J Percussion_Music_Voice measure 215 / measure 1]                       %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Percussion_Music_Voice measure 216 / measure 2]               %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Percussion_Rest_Voice measure 216 / measure 2]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Violin_Music_Voice = {                                                       %! extern
    ...
    % [J Violin_Music_Voice measure 215 / measure 1]                           %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Violin_Music_Voice measure 216 / measure 2]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Violin_Rest_Voice measure 216 / measure 2]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Viola_Music_Voice = {                                                        %! extern
    ...
    % [J Viola_Music_Voice measure 215 / measure 1]                            %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Viola_Music_Voice measure 216 / measure 2]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Viola_Rest_Voice measure 216 / measure 2]                     %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
J_Cello_Music_Voice = {                                                        %! extern
    ...
    % [J Cello_Music_Voice measure 215 / measure 1]                            %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Cello_Music_Voice measure 216 / measure 2]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [J Cello_Rest_Voice measure 216 / measure 2]                     %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
