K_Global_Rests = {                                                             %! extern
    ...
    % [K Global_Rests measure 247 / measure 1]                                 %! _comment_measure_numbers
    R1 * 5/4                                                                   %! _make_global_rests(1)

    % [K Global_Rests measure 248 / measure 2]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [K Global_Rests measure 249 / measure 3]                                 %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [K Global_Rests measure 250 / measure 4]                                 %! _comment_measure_numbers
    ...
    % [K Global_Rests measure 253 / measure 7]                                 %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _make_global_rests(1)

    % [K Global_Rests measure 254 / measure 8]                                 %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [K Global_Rests measure 255 / measure 9]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [K Global_Rests measure 256 / measure 10]                                %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
K_Global_Skips = {                                                             %! extern
    ...
    % [K Global_Skips measure 247 / measure 1]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 248 / measure 2]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 249 / measure 3]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 250 / measure 4]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 252 / measure 6]                                 %! _comment_measure_numbers
    \time 2/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 253 / measure 7]                                 %! _comment_measure_numbers
    s1 * 1/2                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 254 / measure 8]                                 %! _comment_measure_numbers
    \time 3/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 255 / measure 9]                                 %! _comment_measure_numbers
    \time 4/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [K Global_Skips measure 256 / measure 10]                                %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
K_Flute_Music_Voice = {                                                        %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Flute_Music_Voice measure 247 / measure 1]                    %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Flute_Rest_Voice measure 247 / measure 1]                     %! _comment_measure_numbers
    ...
    \times 8/10 {                                                              %! faberge_even_tuplet_rhythm

        % [K Flute_Music_Voice measure 248 / measure 2]                        %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Flute_Music_Voice measure 249 / measure 3]                    %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Flute_Rest_Voice measure 249 / measure 3]                     %! _comment_measure_numbers
    ...
    % [K Flute_Music_Voice measure 250 / measure 4]                            %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c'8                                                                        %! faberge_even_tuplet_rhythm
    - \espressivo                                                              %! baca_espressivo:IndicatorCommand
    [                                                                          %! faberge_even_tuplet_rhythm
    ...
    % [K Flute_Music_Voice measure 252 / measure 6]                            %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _make_measure_silences

    % [K Flute_Music_Voice measure 253 / measure 7]                            %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _make_measure_silences

    % [K Flute_Music_Voice measure 254 / measure 8]                            %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_measure_silences

    % [K Flute_Music_Voice measure 255 / measure 9]                            %! _comment_measure_numbers
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Flute_Music_Voice measure 256 / measure 10]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Flute_Rest_Voice measure 256 / measure 10]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
...
K_English_Horn_Music_Voice = {                                                 %! extern
    ...
    % [K English_Horn_Music_Voice measure 247 / measure 1]                     %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [K English_Horn_Music_Voice measure 248 / measure 2]                     %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands

    % [K English_Horn_Music_Voice measure 249 / measure 3]                     %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K English_Horn_Music_Voice measure 250 / measure 4]                     %! _comment_measure_numbers
    ...
    % [K English_Horn_Music_Voice measure 253 / measure 7]                     %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands

    % [K English_Horn_Music_Voice measure 254 / measure 8]                     %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K English_Horn_Music_Voice measure 255 / measure 9]                     %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K English_Horn_Music_Voice measure 256 / measure 10]            %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K English_Horn_Rest_Voice measure 256 / measure 10]             %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Clarinet_Music_Voice = {                                                     %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Clarinet_Music_Voice measure 247 / measure 1]                 %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Clarinet_Rest_Voice measure 247 / measure 1]                  %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [K Clarinet_Music_Voice measure 248 / measure 2]                         %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c'8                                                                        %! faberge_even_tuplet_rhythm
    - \espressivo                                                              %! baca_espressivo:IndicatorCommand
    [                                                                          %! faberge_even_tuplet_rhythm
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Clarinet_Music_Voice measure 249 / measure 3]                 %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 3/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Clarinet_Rest_Voice measure 249 / measure 3]                  %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    \tweak text #tuplet-number::calc-fraction-text                             %! faberge_even_tuplet_rhythm
    \times 4/6 {                                                               %! faberge_even_tuplet_rhythm

        % [K Clarinet_Music_Voice measure 250 / measure 4]                     %! _comment_measure_numbers
        \baca-unpitched-music-warning                                          %! _color_unpitched_notes
        c'8                                                                    %! faberge_even_tuplet_rhythm
        - \espressivo                                                          %! baca_espressivo:IndicatorCommand
        [                                                                      %! faberge_even_tuplet_rhythm
    ...
    % [K Clarinet_Music_Voice measure 252 / measure 6]                         %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _make_measure_silences

    % [K Clarinet_Music_Voice measure 253 / measure 7]                         %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _make_measure_silences

    % [K Clarinet_Music_Voice measure 254 / measure 8]                         %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_measure_silences

    % [K Clarinet_Music_Voice measure 255 / measure 9]                         %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Clarinet_Music_Voice measure 256 / measure 10]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Clarinet_Rest_Voice measure 256 / measure 10]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Piano_RH_Music_Voice = {                                                     %! extern
    ...
    % [K Piano_RH_Music_Voice measure 247 / measure 1]                         %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [K Piano_RH_Music_Voice measure 248 / measure 2]                         %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands

    % [K Piano_RH_Music_Voice measure 249 / measure 3]                         %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K Piano_RH_Music_Voice measure 250 / measure 4]                         %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands
    ...
    % [K Piano_RH_Music_Voice measure 253 / measure 7]                         %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands

    % [K Piano_RH_Music_Voice measure 254 / measure 8]                         %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K Piano_RH_Music_Voice measure 255 / measure 9]                         %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Piano_RH_Music_Voice measure 256 / measure 10]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Piano_RH_Rest_Voice measure 256 / measure 10]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Piano_LH_Music_Voice = {                                                     %! extern
    ...
    % [K Piano_LH_Music_Voice measure 247 / measure 1]                         %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [K Piano_LH_Music_Voice measure 248 / measure 2]                         %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Music_Voice measure 249 / measure 3]                         %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Music_Voice measure 250 / measure 4]                         %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands
    ...
    % [K Piano_LH_Music_Voice measure 253 / measure 7]                         %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Music_Voice measure 254 / measure 8]                         %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Music_Voice measure 255 / measure 9]                         %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Piano_LH_Music_Voice measure 256 / measure 10]                %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Piano_LH_Rest_Voice measure 256 / measure 10]                 %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Piano_LH_Attack_Voice = {                                                    %! extern
    ...
    % [K Piano_LH_Attack_Voice measure 247 / measure 1]                        %! _comment_measure_numbers
    R1 * 5/4                                                                   %! _call_rhythm_commands
    - \tweak color #(x11-color 'green4)                                        %! REAPPLIED_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \sfz                                                                       %! REAPPLIED_DYNAMIC:_set_status_tag:_reapply_persistent_indicators(3)

    % [K Piano_LH_Attack_Voice measure 248 / measure 2]                        %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Attack_Voice measure 249 / measure 3]                        %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Attack_Voice measure 250 / measure 4]                        %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands
    ...
    % [K Piano_LH_Attack_Voice measure 253 / measure 7]                        %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Attack_Voice measure 254 / measure 8]                        %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _call_rhythm_commands

    % [K Piano_LH_Attack_Voice measure 255 / measure 9]                        %! _comment_measure_numbers
    R1 * 1/1                                                                   %! _call_rhythm_commands
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Piano_LH_Attack_Voice measure 256 / measure 10]               %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Piano_LH_Attack_Rest_Voice measure 256 / measure 10]          %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Percussion_Music_Voice = {                                                   %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Percussion_Music_Voice measure 247 / measure 1]               %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Percussion_Rest_Voice measure 247 / measure 1]                %! _comment_measure_numbers
            R1 * 5/4                                                           %! _make_multimeasure_rest_container
    ...
    % [K Percussion_Music_Voice measure 248 / measure 2]                       %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Percussion_Music_Voice measure 249 / measure 3]               %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            a'1 * 3/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Percussion_Rest_Voice measure 249 / measure 3]                %! _comment_measure_numbers
            R1 * 3/4                                                           %! _make_multimeasure_rest_container
    ...
    % [K Percussion_Music_Voice measure 250 / measure 4]                       %! _comment_measure_numbers
    a'4                                                                        %! faberge_downbeat_attack
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak circled-tip ##t                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
    - \tweak stencil #abjad-flared-hairpin                                     %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [K Percussion_Rest_Voice measure 251 / measure 5]                %! _comment_measure_numbers
            R1 * 9/4                                                           %! _make_multimeasure_rest_container
    ...
    % [K Percussion_Music_Voice measure 253 / measure 7]                       %! _comment_measure_numbers
    R1 * 1/2                                                                   %! _make_measure_silences

    % [K Percussion_Music_Voice measure 254 / measure 8]                       %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_measure_silences

    % [K Percussion_Music_Voice measure 255 / measure 9]                       %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Percussion_Music_Voice measure 256 / measure 10]              %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Percussion_Rest_Voice measure 256 / measure 10]               %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Violin_Music_Voice = {                                                       %! extern
    ...
    \times 18/20 {                                                             %! faberge_clb_rhythm
        ...
        % [K Violin_Music_Voice measure 247 / measure 1]                       %! _comment_measure_numbers
    ...
    % [K Violin_Music_Voice measure 249 / measure 3]                           %! _comment_measure_numbers
    ...
    \times 4/6 {                                                               %! faberge_clb_rhythm
        ...
        % [K Violin_Music_Voice measure 250 / measure 4]                       %! _comment_measure_numbers
        b'8                                                                    %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    \times 8/10 {                                                              %! faberge_clb_rhythm
        ...
        % [K Violin_Music_Voice measure 252 / measure 6]                       %! _comment_measure_numbers
        \override Stem.direction = #down                                       %! baca_stem_down:OverrideCommand(1)
        \override TupletBracket.staff-padding = #3.5                           %! baca_tuplet_bracket_staff_padding:OverrideCommand(1)
        a'8                                                                    %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        ...
        % [K Violin_Music_Voice measure 253 / measure 7]                       %! _comment_measure_numbers
        a'8                                                                    %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
    ...
    % [K Violin_Music_Voice measure 254 / measure 8]                           %! _comment_measure_numbers
    a'8                                                                        %! faberge_clb_rhythm
    - \staccato                                                                %! baca_staccato:IndicatorCommand
    [                                                                          %! faberge_clb_rhythm
    ...
    \times 8/10 {                                                              %! faberge_clb_rhythm
        ...
        % [K Violin_Music_Voice measure 255 / measure 9]                       %! _comment_measure_numbers
        b'8                                                                    %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Violin_Music_Voice measure 256 / measure 10]                  %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Violin_Rest_Voice measure 256 / measure 10]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Viola_Music_Voice = {                                                        %! extern
    ...
    % [K Viola_Music_Voice measure 247 / measure 1]                            %! _comment_measure_numbers
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [K Viola_Music_Voice measure 248 / measure 2]                            %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c'1                                                                        %! baca_make_repeat_tied_notes
    - \tweak direction #up
    \repeatTie

    % [K Viola_Music_Voice measure 249 / measure 3]                            %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c'2.                                                                       %! baca_make_repeat_tied_notes
    \repeatTie

    % [K Viola_Music_Voice measure 250 / measure 4]                            %! _comment_measure_numbers
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c'2                                                                        %! baca_make_repeat_tied_notes
    \repeatTie
    ...
    \times 4/6 {                                                               %! faberge_clb_rhythm
        ...
        % [K Viola_Music_Voice measure 252 / measure 6]                        %! _comment_measure_numbers
        \stopStaff                                                             %! EXPLICIT_STAFF_LINES:_set_status_tag:baca_staff_lines:IndicatorCommand
        \once \override Staff.StaffSymbol.line-count = 1                       %! EXPLICIT_STAFF_LINES:_set_status_tag:baca_staff_lines:IndicatorCommand
        \startStaff                                                            %! EXPLICIT_STAFF_LINES:_set_status_tag:baca_staff_lines:IndicatorCommand
        \override Stem.direction = #down                                       %! baca_stem_down:OverrideCommand(1)
    ...
    \times 10/16 {                                                             %! faberge_clb_rhythm
        ...
        % [K Viola_Music_Voice measure 253 / measure 7]                        %! _comment_measure_numbers
        c'8                                                                    %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    \times 8/10 {                                                              %! faberge_clb_rhythm
        ...
        % [K Viola_Music_Voice measure 255 / measure 9]                        %! _comment_measure_numbers
        d'8                                                                    %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Viola_Music_Voice measure 256 / measure 10]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Viola_Rest_Voice measure 256 / measure 10]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
...
K_Cello_Music_Voice = {                                                        %! extern
    ...
    \times 10/12 {                                                             %! faberge_clb_rhythm
        ...
        % [K Cello_Music_Voice measure 247 / measure 1]                        %! _comment_measure_numbers
    ...
    \times 8/14 {                                                              %! faberge_clb_rhythm
        ...
        % [K Cello_Music_Voice measure 248 / measure 2]                        %! _comment_measure_numbers
        d8                                                                     %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    \times 10/12 {                                                             %! faberge_clb_rhythm
        ...
        % [K Cello_Music_Voice measure 249 / measure 3]                        %! _comment_measure_numbers
        d8                                                                     %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    \times 4/6 {                                                               %! faberge_clb_rhythm
        ...
        % [K Cello_Music_Voice measure 252 / measure 6]                        %! _comment_measure_numbers
        \override Stem.direction = #down                                       %! baca_stem_down:OverrideCommand(1)
        \override TupletBracket.staff-padding = #3.5                           %! baca_tuplet_bracket_staff_padding:OverrideCommand(1)
        c8                                                                     %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
    ...
    \times 4/6 {                                                               %! faberge_clb_rhythm
        ...
        % [K Cello_Music_Voice measure 253 / measure 7]                        %! _comment_measure_numbers
        d8                                                                     %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    \times 14/16 {                                                             %! faberge_clb_rhythm
        ...
        % [K Cello_Music_Voice measure 254 / measure 8]                        %! _comment_measure_numbers
        d8                                                                     %! faberge_clb_rhythm
        - \staccato                                                            %! baca_staccato:IndicatorCommand
        [                                                                      %! faberge_clb_rhythm
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Cello_Music_Voice measure 256 / measure 10]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [K Cello_Rest_Voice measure 256 / measure 10]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
