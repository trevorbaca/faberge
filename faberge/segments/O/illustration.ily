...
O_Flute_Music_Voice = {                                                        %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [O Flute_Rest_Voice measure 279 / measure 1]                     %! _comment_measure_numbers
...
O_English_Horn_Music_Voice = {                                                 %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [O English_Horn_Rest_Voice measure 279 / measure 1]              %! _comment_measure_numbers
            R1 * 2                                                             %! _make_multimeasure_rest_container
...
O_Clarinet_Music_Voice = {                                                     %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [O Clarinet_Rest_Voice measure 279 / measure 1]                  %! _comment_measure_numbers
            R1 * 2                                                             %! _make_multimeasure_rest_container
...
O_Piano_RH_Music_Voice = {                                                     %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [O Piano_RH_Rest_Voice measure 279 / measure 1]                  %! _comment_measure_numbers
            R1 * 2                                                             %! _make_multimeasure_rest_container
