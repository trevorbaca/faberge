...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    \times 4/5 {                                                               %! faberge.suffixed_colortrill_rhythm()
        ...
        - \baca-text-spanner-left-text "1-5 / 2-1"                             %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1)
...
E_Violin_Music_Voice = {                                                       %! abjad.Path.extern()
    ...
    \times 9/5 {                                                               %! baca.skeleton()
        ...
        - \abjad-solid-line-with-hook                                          %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1)
        - \baca-text-spanner-left-text "3-1"                                   %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1)
        - \tweak bound-details.right.padding #3.25                             %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1):autodetect
        - \tweak color #darkgreen                                              %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1)
        - \tweak staff-padding #8                                              %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1)
        \bacaStartTextSpanMA                                                   %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(1)
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7)
        ...
        %@% \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container(3):INVISIBLE_MUSIC:HIDDEN_NOTE
            \once \override Staff.StaffSymbol.color = #(x11-color 'blue)       %! baca.SegmentMaker._attach_color_literal(2):EXPLICIT_STAFF_LINES_COLOR
            \baca-not-yet-pitched-coloring                                     %! baca.SegmentMaker._color_not_yet_pitched():NOT_YET_PITCHED
            b'1 * 2                                                            %! baca.SegmentMaker._make_multimeasure_rest_container(1):HIDDEN_NOTE
...
%@% ^ \baca-duration-multiplier-markup #"1" #"4"                               %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER
    ...
    %@% \override Staff.Clef.color = ##f                                       %! baca.SegmentMaker._attach_color_literal(1):EXPLICIT_CLEF_COLOR_CANCELLATION
        ...
        \bacaStopTextSpanMA                                                    %! baca.material_annotation_spanner():MATERIAL:baca.PiecewiseCommand._call(3):SPANNER_STOP
        \glissando                                                             %! baca.glissando()
        - \abjad-dashed-line-with-hook                                         %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(1):right_broken
        - \baca-text-spanner-left-text "XFB"                                   %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(1):right_broken
        - \tweak bound-details.left-broken.text \baca-left-broken-xfb-markup   %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(1):right_broken
        - \tweak bound-details.right.padding #2.5                              %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(1):right_broken:autodetect
        - \tweak staff-padding #3                                              %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(1):right_broken
        \bacaStartTextSpanBowSpeed                                             %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(1):right_broken
        \override Staff.Clef.color = #(x11-color 'DeepSkyBlue2)                %! baca.SegmentMaker._attach_color_literal(2):EXPLICIT_CLEF_REDRAW_COLOR
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7):PHANTOM
        ...
        %@% \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container(3):PHANTOM:INVISIBLE_MUSIC:PHANTOM_NOTE:baca.SegmentMaker._style_phantom_measures(5)
            ...
            d1 * 1/4                                                           %! baca.SegmentMaker._make_multimeasure_rest_container(1):PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \bacaStopTextSpanBowSpeed                                          %! baca.xfb_spanner():BOW_SPEED:baca.PiecewiseCommand._call(3):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
