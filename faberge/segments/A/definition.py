...
maker(
    ('va', 3),
    baca.new_hairpin('pp < mp', selector=baca.rleaves()),
    )
...
maker(
    ('vc', (1, 2)),
    baca.new_hairpin('p < f', selector=baca.rleaves()),
    baca.transition(
...
maker(
    ('vc', (4, 6)),
    baca.new_hairpin('f > p', selector=baca.rleaves()),
    baca.transition(
...
maker(
    ('vc', (14, 15)),
    baca.new_hairpin('ff > pp', selector=baca.rleaves()),
    baca.transition(
