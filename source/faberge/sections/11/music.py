...
def vn(m):
    ...
    with baca.scope(m[3]) as o:
        ...
        for plt in baca.select.plts(o):
            ...
            elif duration == abjad.ValueDuration(1, 4):
...
def make_layout(environment):
    ...
    spacing = baca.layout.Spacing(
        default=(1, 20),
        strict_overrides=(baca.layout.Override((1, 4), (1, 32)),),
    )
